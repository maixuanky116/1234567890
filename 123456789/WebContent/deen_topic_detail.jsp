                    ...
                    <div class="panel-body">
                        <div class="panel-group" id="accordion">
                                ...
                                <div id="collapse1" class="panel-collapse collapse in">
                                    <div class="panel-body" id="type_topic">
                                        <div class="list-group">
                                            ...
                                            <a href="#" class="list-group-item">Tất cả đề tài</a>
                                        </div>
                            ...
                            <div class="panel panel-default ">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Danh sách giảng viên</a>
                                    </h4>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div class="col-md-4 col-md-content">
                                    <div class="panel panel-default" id="panel-default-tvhd">
                                        <div class="panel-body">
                                            ...
                                            <table class="table table-fixed" style="margin-bottom: 5px">
                                                <thead style="background-color:#F0D4D4; ">
                                                    <tr>
                                                        <th class="col-md-3">MGV</th>
                                                        <th class="col-md-9">Tên GV</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td class="col-md-3">GV2</td>
                                                        <td class="col-md-9">Nguyễn văn A</td>
