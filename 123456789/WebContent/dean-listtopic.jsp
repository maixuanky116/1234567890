                                ...
                                <table class="table table_list">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-3 btn_float_righ">Chi tiết</th>
                                        </tr>
                                    </thead>
                                    <tbody id ="table_body">
                                        <tr>
                                           <th class="col-md-1">1</th>
                                            ...
                                            <th class="col-md-3"><a href="deen_topic_detail.jsp">Xem chi tiết</a></td>
                                        </tr>
                                        <tr>
                                            <th class="col-md-1">1</th>
                                            <th class="col-md-2">DT1</td>
                                            <th class="col-md-4">Đề tài 1</td>
                                            <th class="col-md-3">Đang chờ</td>
                                            <th class="col-md-3"><a href="#">Xem chi tiết</a></td>
                                        </tr>
                                        <tr>
                                            <th class="col-md-1">1</th>
                                            <th class="col-md-2">DT1</td>
