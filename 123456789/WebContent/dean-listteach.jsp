                                ...
                                <table class="table table_list">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-2">MGV </th>
                                            <th class="col-md-4">Tên Giảng viên</th>
                                            <th class="col-md-3">Ngày sinh</th>
                                            <th class="col-md-3 btn_float_righ">Lịch phân công</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <th class="col-md-1">1</th>
                                            <th class="col-md-2">GV1 </th>
                                            <th class="col-md-4"> Giảng viên 1</th>
                                            <th class="col-md-3">01/01/1996</th>
                                            <th class="col-md-3 btn_float_righ"><a href ="dean-teachcal.jsp">Lịch phân công</a></th>
                                        </tr>
                                        <tr>
                                            <th class="col-md-1">2</th>
                                            <th class="col-md-2">GV2 </th>
                                            <th class="col-md-4"> Giảng viên 2</th>
                                            <th class="col-md-3">01/02/1996</th>
                                            <th class="col-md-3 btn_float_righ"><a href ="#">Lịch phân công</a></th>
                                        </tr>
                                        <tr>
                                            <th class="col-md-1">3</th>
                                            <th class="col-md-2">GV3
                                            </th>
                                            <th class="col-md-4"> Giảng viên 3</th>
                                            <th class="col-md-3">01/03/1996</th>
                                            <th class="col-md-3 btn_float_righ"><a href ="#">Lịch phân công</a></th>
                                        </tr>
                                        <tr>
                                            <th class="col-md-1">4</th>
                                            <th class="col-md-2">GV4</th>
                                            <th class="col-md-4"> Giảng viên 4</th>
                                            <th class="col-md-3">01/21/1996</th>
                                            <th class="col-md-3 btn_float_righ"><a href ="#">Lịch phân công</a></th>
                                        </tr>
