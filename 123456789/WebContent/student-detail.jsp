	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-9">
				<div class="panel panel-primary panel-fullheight">
					<div class="panel-heading">
						<h3 class="panel-title"> Đề tài</h3>
					</div>

					<div class="panel-body">
						<ul class="nav nav-tabs">
							<li class="nav active"><a href="#A" data-toggle="tab" aria-expanded="true">Chi tiết</a></li>
							<li class="nav"><a href="#B" data-toggle="tab" aria-expanded="false">Nộp bài</a></li>
							<li class="nav"><a href="#C" data-toggle="tab" aria-expanded="false">Báo cáo</a></li>
							<li class="nav"><a href="#D" data-toggle="tab" aria-expanded="false">Kết quả</a></li>
						</ul>
						<div class="tab-content" id="Tabcontent">
							<div class="tab-pane fade active in" id="A">
								<ul class="list-group list-group-detail">
									<li class="list-group-item">
										<p><strong>Mô tả:</strong> Phần mềm giúp người dùng truy cập được các phầm mềm của window</p>
									</li>
