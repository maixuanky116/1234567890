                    ...
                    <div class="panel-body">
                        <div class="panel-group" id="accordion">
                                ...
                                <div id="collapse1" class="panel-collapse collapse in">
                                    <div class="panel-body" id="type_topic">
                                        <div class="list-group" >
                                            ...
                                            <a href="GV_detaiPCUV.jsp" class="list-group-item ">Đề tài phân công làm ủy viên HĐ</a>
                                            <a href="GV_TrangChu.jsp" class="list-group-item list-group-item-info">Tất cả đề tài</a>
                                        </div>
                            ...
                            <div class="panel panel-default " id="panel_list">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-parent="#accordion" href="GV_DSHD.jsp">Danh sách hội đồng</a>
                                    </h4>
                                </div>
                            </div>
