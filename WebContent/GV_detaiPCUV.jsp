                    ...
                    <div class="panel-body">
                        <div class="panel-group" id="accordion">
                                ...
                                <div id="collapse1" class="panel-collapse collapse in">
                                    <div class="panel-body" id="type_topic">
                                        <div class="list-group" >
                                            <a href="GV_detaiPCPB.jsp" class="list-group-item ">Đề tài phân công phản biện</a>
                                            <a href="GV_detaiPCUV.jsp" class="list-group-item list-group-item-info">Đề tài phân công làm ủy viên HĐ</a>
                                            <a href="GV_TrangChu.jsp" class="list-group-item ">Tất cả đề tài</a>
                                        </div>
                            ...
                            <div class="panel panel-default " id="panel_list">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a href="GV_DSHD.jsp">Danh sách hội đồng</a>
                                    </h4>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a href="GV_XemBC-PhanBien.jsp">Xem báo cáo</a>
                                        </h4>
                                    </div>
                                </div>
                            <div class="panel panel-default">
                                ...
                                <table class="table table_list">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Ủy viên</td>   
                                            <td>Đã báo cáo</td> 
                                            <td><a href="#" data-toggle="modal" data-target="#chitiet1" >Xem chi tiết</a></td>
                                        </tr>
                                        <tr>
                                            <th scope="row">2</th>
                                            <td>DT2</td>
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <ul class="list-group list-group-detail">
                                            ...
                                            <li class="list-group-item">
                                                <p><strong>Giảng viên hướng dẫn:</strong> Nguyễn Văn A</p>
                                            </li>
                                            <li class="list-group-item">
                                            ...
                                            <li class="list-group-item">
                                                <p><strong>Tóm tắt đề tài: </strong> Tóm tắt đề tài 1</p>
                                            </li>
                                            <li class="list-group-item">
                                                <td><p><strong> File thuyết minh: </strong> <button style="margin-left: 30px"><i class="glyphicon glyphicon-tags pull-center" style="font-size: 20px"></i></button></p></td>
                                            </li>
